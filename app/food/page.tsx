          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-3">
                <div className="relative overflow-hidden rounded-[1.4rem] border border-blue-200/60 bg-gradient-to-br from-blue-50 to-indigo-50/60 p-4 dark:border-blue-500/20 dark:bg-gradient-to-br dark:from-blue-500/12 dark:to-indigo-600/6"><div className="absolute -right-3 -top-3 h-14 w-14 rounded-full bg-blue-400/20 blur-xl" /><p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#1A6BFF]">{copy.consumed}</p><p className="mt-3 text-3xl font-black text-slate-950 dark:text-white">{Math.round(totals.calories)}</p><p className="text-sm text-slate-500 dark:text-slate-400">{copy.kcalToday}</p></div>
                <div className="relative overflow-hidden rounded-[1.4rem] border border-emerald-200/60 bg-gradient-to-br from-emerald-50 to-teal-50/60 p-4 dark:border-emerald-500/20 dark:bg-gradient-to-br dark:from-emerald-500/12 dark:to-teal-600/6"><div className="absolute -right-3 -top-3 h-14 w-14 rounded-full bg-emerald-400/20 blur-xl" /><p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-600">{copy.remaining}</p><p className="mt-3 text-3xl font-black text-slate-950 dark:text-white">{remaining}</p><p className="text-sm text-slate-500 dark:text-slate-400">{copy.kcalLeft}</p></div>
                <div className="relative overflow-hidden rounded-[1.4rem] border border-violet-200/60 bg-gradient-to-br from-violet-50 to-purple-50/60 p-4 dark:border-violet-500/20 dark:bg-gradient-to-br dark:from-violet-500/12 dark:to-purple-600/6"><div className="absolute -right-3 -top-3 h-14 w-14 rounded-full bg-violet-400/20 blur-xl" /><p className="text-xs font-semibold uppercase tracking-[0.18em] text-violet-600">{copy.logged}</p><p className="mt-3 text-3xl font-black text-slate-950 dark:text-white">{loggedFoods.length}</p><p className="text-sm text-slate-500 dark:text-slate-400">{copy.foodEntries}</p></div>
              </div>
            </div>
