...
const caloriesCopy: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    hydration: 'مياه', steps: 'الخطوات',
    completeProfile: 'أكمل ملفك لفتح أهداف مخصصة للسعرات والمغذيات والماء حسب بيانات جسمك.',
    ...
    lblCalories: 'السعرات', lblHydration: 'مياه', lblSteps: 'الخطوات', lblMetabolic: 'الأيضي',
